...
for model_name in args.models:
    ...
    for number_use in [False,True]:
        for graph_use in [False,True]:
            ...
            if args.CLADDER:
                file_name = args.outputdataset+str(args.method)+"_model_name "+model_name_folder+" graph included "+str(graph_use)+" number use "+str(number_use)+"_CLADDER.csv"
            else:
                file_name = args.outputdataset+str(args.method)+"_model_name "+model_name_folder+" graph included "+str(graph_use)+" number use "+str(number_use)+".csv"
